...
public:
	...
	virtual bool        __stdcall CreateGui(IfaceCallBackGui* ig) { ifaceGui = ig; return true; };
	virtual bool        __stdcall CreateProc(IfaceCallBackProc* ip) { ifaceProc = ip; return true; }

	virtual bool		__stdcall Initialize() { recv = 0; send = 0; return true; };
